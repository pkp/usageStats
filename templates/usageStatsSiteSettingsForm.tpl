...
<form class="pkp_form" id="usageStatsSettingsForm" method="post" action="{url router=PKPApplication::ROUTE_COMPONENT op="manage" category="generic" plugin=$pluginName verb="save"}">
	{csrf}
